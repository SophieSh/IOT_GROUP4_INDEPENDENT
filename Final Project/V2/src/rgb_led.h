...
#ifndef SRC_RGB_LED_H
#define SRC_RGB_LED_H
...
const int R_CHANNEL = 1;    // LEDC channel for Red
const int G_CHANNEL = 2;    // LEDC channel for Green
const int B_CHANNEL = 3;    // LEDC channel for Blue
