...
When the user (the child) opens the app, they can choose between two languages — Hebrew and English — and then the game begins with the first image displayed. The user is required to provide the first letter of the object shown in the image.
